...
public class CursosResourceTest extends AbstractResourceTest{
    ...
    public void testGetById_withInvalidId_shouldReturnNotFoundException() {
        // given
        String id = "1931fdb3-2143-4cbc-933a-984f8d5f2955";
    ...
    public void testCreate() {
        // given
        String id = null;
        CursoRequest request = new CursoRequest(id, "Exatas", "Ciência da Computação", PRESENCIAL, 8);
    ...
    public void testUpdate() {
        ...
        CursoResponse salvo = response.body().as(CursoResponse.class);
        id = salvo.getId();

        CursoRequest update = new CursoRequest(id, "Exatas", "Sistemas de Informação", SEMI_PRESENCIAL, 7);
